...
class NeRF(nn.Module):
    ...
    * Complete Neural Network for training
    ...
    def __init__(self, pos_dim=10, view_dim=8, dense_features=256, dense_depth=8, dense_features_fine=256, dense_depth_fine=8, in_features=3) -> None:
        super().__init__()
        ...
        self.coarse_model = _NeRF(
            inpos_features=self.pos_encoder.out_features * in_features,
